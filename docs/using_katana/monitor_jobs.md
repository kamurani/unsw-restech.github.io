...
```
then search for Output_Path. For example, in the below example, the absolute path of the output file is ```/home/z123456/output_file.txt```. Interactive jobs do not show a file name; for those cases the output file name will look like ```4638435.kman.restech.unsw.edu.au.OU``` and is placed in the folder where you submitted the job:
```bash
